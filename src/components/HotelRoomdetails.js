  ...
  return (
    <>
      ...
      <div className="flex flex-col">
        ...
        <section ref={overviewRef} className="scroll-mt-24 py-3 ">
          <div className="bg-white border rounded-lg p-4 sm:p-6 md:p-8 shadow-sm">
            {/* Heading */}
            <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-4 border-l-4 border-blue-600 pl-3">
              Package Overview
            </h2>
      ...
      <section ref={itineraryRef} className="scroll-mt-24">
        <div className="bg-white border rounded-lg p-4 sm:p-6 md:p-8 shadow-sm">
          <h2 className="text-lg sm:text-2xl md:text-3xl font-semibold text-gray-900 mb-6 border-l-4 border-blue-600 pl-3">
            Day Wise Itinerary
          </h2>
              ...
              packagedata?.itineraries.map((item, index) => (
                <div key={index} className="mb-8 sm:mb-10 relative">
                  ...
                  <div className="absolute -left-[28px] sm:-left-[39px] flex flex-col items-center">
                    <div
                      className="bg-[#009CFF] text-white font-semibold rounded-full 
